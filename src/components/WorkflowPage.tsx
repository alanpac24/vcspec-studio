...
export const WorkflowPage = ({ workflowType, title, description, exampleCommand }: WorkflowPageProps) => {
      ...
      <div className="flex items-center justify-center py-12">
        <div className="text-center max-w-md">
          ...
          <p className="text-xs text-grey-400 mt-4">
            Use the command bar to say: "{exampleCommand}"
          </p>
        </div>
      </div>
    );
  ...
  return (
    <WorkflowMapView title={title} workflowId={workflowId} />
  );
};
